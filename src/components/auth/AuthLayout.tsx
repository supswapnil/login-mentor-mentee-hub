...
export const AuthLayout = ({ children, type }: AuthLayoutProps) => {
  return (
    <div className="min-h-screen w-full bg-accent flex">
      {type === 'login' ? (
        <>
          <motion.div
          ...
          >
            ...
            <button
              ...
              className="px-8 py-3 rounded-lg bg-transparent border-2 border-white hover:bg-white hover:text-primary transition-all duration-300"
            >
              Register
            </button>
          </motion.div>
